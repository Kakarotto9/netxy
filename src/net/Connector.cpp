...
namespace netxy
{
    namespace net
    {
        class ConnectorWorkThread final : public netxy::NonCopyable
        {
        public:
            ...
            void                checkTimeout();
            void                pollConnectRequest(netxy::MsgQueue<AsyncConnectAddr>& connectRequests);
...
void ConnectorWorkThread::pollConnectRequest(netxy::MsgQueue<AsyncConnectAddr>& connectRequests)
{
